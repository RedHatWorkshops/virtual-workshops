...
. Log in to link:{api-management-url}[3scale Admin, window="_blank"] web console by selecting the _Authenticate through Red Hat Single Sign-On_ option.
+
...
. Select *basic-integration* as the _Application Plan_. Select *Default* as the _Service Plan_. Enter *i-integration-evals02* as the _Name_. Click *Create Applicatio*n. An Application page should appear. It will contain a newly created API User Key for use with your new `i-integration-evals02` application.
+
